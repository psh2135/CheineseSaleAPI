...
namespace ChineseSaleApi.Migrations
{
    ...
    [Migration("20260127213507_initialCreate00")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PackagePurchase", b =>
                {
                    b.HasOne("ChineseSaleApi.Models.Package", null)
                        .WithMany()
                        .HasForeignKey("PackagesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ChineseSaleApi.Models.Purchase", null)
                        .WithMany()
